...
#pragma warning restore 3001, 3002
        ...
        /// <summary>
        /// Read an <see cref="System.UInt32"/> (Little-endian),
        /// and move the pointer accordingly
        /// </summary>
        /// <returns></returns>
        public UInt32 ReadUInt32LE()
        {
            int ptr = Position + 1;
            Position += 4;
            return ByteArrayHelpers.ReadUInt32LE(
                _buffer,
                ptr);
        }
        ...
        /// <summary>
        /// Read an <see cref="System.UInt32"/> (Big-endian),
        /// and move the pointer accordingly
        /// </summary>
        /// <returns></returns>
        public UInt32 ReadUInt32BE()
        {
            int ptr = Position + 1;
            Position += 4;
            return ByteArrayHelpers.ReadUInt32BE(
                _buffer,
                ptr);
        }
